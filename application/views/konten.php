                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <select class="custom-select" id="inlineFormCustomSelect">
                                ...
                                <option value="2">Non Ticket</option>
                                    ...
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuAuthor">
                                                ...
                                                <div class="all-users">
                                                    <a class="dropdown-item" href="#0" data-rel="PS.PUSAT.POLMA">
                                                        <img src="img/home_support/fl1.png" alt="user">
                                                        Polma Saut Martua Sihotang
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.51.HARDHIYANTOEKO">
                                                        <img src="img/home_support/fl2.png" alt="user">
                                                        Hardhiyanto Eko Saputro
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.PUSAT.BETY">
                                                        <img src="img/home_support/fl3.png" alt="user">
                                                        Bety Elysabeth Pasaribu
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.PUSAT.EZRA">
                                                        <img src="img/home_support/fl4.png" alt="user">
                                                        Ezra Andriani Sihotang
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.51.ADHISETIAWAN">
                                                        <img src="img/home_support/fl5.png" alt="user">
                                                        Adhi Setiawan
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.51.FATHOLLAILI">
                                                        <img src="img/home_support/fl6.png" alt="user">
                                                        Fathol Laili
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.51.SUKMATRIYONO">
                                                        <img src="img/home_support/fl7.png" alt="user">
                                                        Sukma Triyono Priyo
                                                    </a>
                                                    <a class="dropdown-item" href="#0" data-rel="PS.PUSAT.KARYANI">
                                    ...
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLabel">
                                                ...
                                                <div class="all-users">
                                                    <a class="dropdown-item" data-rel="ITSM" href="#0">
                                                        <span class="color-purple"></span>
                                                        ITSM
                                                    </a>
                                                    <a class="dropdown-item" data-rel="Non_Ticket" href="#0">
                                                        <span class="color-yellow">
                                                        </span>
                                                        Non Ticket
                                                    </a>
                                                    <a class="dropdown-item" data-rel="Permintaan_Data" href="#0">
                            ...
                            <div class="community-post style-two kbDoc richard bug">
                                <div class="post-content">
                                    ...
                                    <div class="entry-content">
                                        <h3 class="post-title">
                                            <a href="forum-single.html">AP2T 17370 TIDAK BISA REMAJA KARENA ADA 2 PDL AKTIF GANTI METER</a>
                                        </h3>
                                        <ul class="meta">
                                            <li><img src="img/home_support/cmm1.png" alt="cmm"><a href="#">Polma Saut Martua Sihotang</a></li>
											<li>Category: <a class="badge color-green" href="#">FSO</a><a class="badge color-purple" href="#">PDL</a></li>
                                        </ul>
                                    </div>
                                </div>
